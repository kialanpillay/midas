...
for i in range(1,pages):
    url = "https://newsapi.org/v2/everything?q=(gold AND commodity) OR XAUUSD&page="+str(i)+"&apiKey=e3c7d810af0e41dd869013ab5c5d66e9"
    r = requests.get(url=url)
    data = r.json()
    print(data)
...
for article in data['articles']:
    ...
    classification = classifier.classify(dict([token, True] for token in description_tokens))
...
results = counter
print(positive_articles/results)
print(negative_articles/results)